...
void prepareTerrain() {
	...
	for (int i = 1; i < imageWidth - 2; i++) {
		for (int j = 1; j < imageWidth - 1; j++) {
			...
			// Multiplicar os valores de texCoord altera o numero de vezes q a imagem se repete / tamanho
...
void loadTexture() {
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);//GL_LINEAR_MIPMAP_NEAREST  GL_NEAREST_MIPMAP_LINEAR GL_NEAREST_MIPMAP_NEAREST
